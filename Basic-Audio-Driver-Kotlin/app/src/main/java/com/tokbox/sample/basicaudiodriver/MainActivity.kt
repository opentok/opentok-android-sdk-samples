...
import com.tokbox.sample.basicaudiodriver.MainActivity
import com.tokbox.sample.basicaudiodriver.OpenTokConfig.description
import com.tokbox.sample.basicaudiodriver.OpenTokConfig.isValid
...
class MainActivity : AppCompatActivity(), PermissionCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!isValid) {
            finishWithMessage("Invalid OpenTokConfig.INSTANCE. $description")
            return
        }
