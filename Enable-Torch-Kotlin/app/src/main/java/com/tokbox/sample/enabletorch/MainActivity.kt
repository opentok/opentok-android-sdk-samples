...
import com.tokbox.sample.enabletorch.network.APIService
import com.tokbox.sample.enabletorch.network.GetSessionResponse
...
class MainActivity : AppCompatActivity(), PermissionCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonVideoTransformers = findViewById(R.id.setenabletorch)
