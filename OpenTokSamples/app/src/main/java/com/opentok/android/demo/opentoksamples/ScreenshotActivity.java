...
import com.opentok.android.demo.video.BasicCustomVideoRenderer;
...
public class ScreenshotActivity extends Activity implements
    ...
    private RelativeLayout screenshotWidget;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        screenshotWidget = (RelativeLayout) findViewById(R.id.screenshotWidget);
    ...
    public void onPause() {
        ...
        Intent notificationIntent = new Intent(this, ScreenshotActivity.class);
        ...
        if (mConnection == null) {
            mConnection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName className, IBinder binder) {
                    ((ClearNotificationService.ClearBinder) binder).service.startService(new Intent(ScreenshotActivity.this, ClearNotificationService.class));
        ...
        if (!mIsBound) {
            bindService(new Intent(ScreenshotActivity.this,
    ...
    private void sessionConnect() {
        if (mSession == null) {
            mSession = new Session(ScreenshotActivity.this,
    ...
    public void onConnected(Session session) {
        ...
        if (mPublisher == null) {
            mPublisher = new Publisher(ScreenshotActivity.this, "publisher");
    ...
    private void attachSubscriberView(Subscriber subscriber) {
        ...
        screenshotWidget.setVisibility(View.VISIBLE);
    }
    ...
    public void onStreamDropped(Session session, Stream stream) {
        if (!OpenTokConfig.SUBSCRIBE_TO_SELF) {
            if (mSubscriber != null) {
                ...
                screenshotWidget.setVisibility(View.GONE);
            }
        }
    }
