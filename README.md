...
1. Import the project into Android Studio.
   ...
   This project needs the opentok-android-sdk-2.4.1.jar file and the armeabi/libopentok.so or
   ...
   * Copy the opentok-android-sdk-2.4.1.jar file into the libs directory of the app module.
