...
import com.tokbox.sample.livephotocapture.MainActivity
import com.tokbox.sample.livephotocapture.OpenTokConfig.description
import com.tokbox.sample.livephotocapture.OpenTokConfig.isValid
...
class MainActivity : AppCompatActivity(), PermissionCallbacks {
    ...
    private val sessionListener: SessionListener = object : SessionListener {
        ...
        override fun onStreamReceived(session: Session, stream: Stream) {
            ...
            subscriber = Subscriber.Builder(this@MainActivity, stream)
                .renderer(ScreenshotVideoRenderer(this@MainActivity))
                .build()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val button = findViewById<Button>(R.id.screenshotButton)
        ...
        button.setOnClickListener {
            ...
            (subscriber?.renderer as ScreenshotVideoRenderer).saveScreenshot()
