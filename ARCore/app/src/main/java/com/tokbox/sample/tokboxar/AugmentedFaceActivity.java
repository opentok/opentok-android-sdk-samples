...
public class AugmentedFaceActivity extends AppCompatActivity implements Scene.OnUpdateListener, Session.SessionListener, PublisherKit.PublisherListener {
  private static final String LOG_TAG = AugmentedFaceActivity.class.getSimpleName();
